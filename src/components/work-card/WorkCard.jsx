...
function WorkCard(props) {
  ...
  return (
    <div
      ...
      className="p-6 border border-white w-[97%] w-max-[1280px] min-h-[72px] justify-center flex flex-col items-center rounded-lg transition-all duration-300 ease-in-out hover:opacity-80 cursor-pointer"
    >
